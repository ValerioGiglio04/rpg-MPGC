...
- **Stato palestre** (calcolato da `GameModel.statusOf` / enum `GymStatus`):
...
- **Motore:** `TurnBasedCombatEngine` risolve colpo/danno/miss; `AccuracyThresholdBossMoveStrategy` sceglie la mossa del boss.
